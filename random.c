    ...
    if ((cn=map[m].ch)) {
        if (ch[cn].flags&CF_PLAYER) {
            ...
            if (!teleport_char_driver(cn,245,250) &&
                ...
                !change_area(cn,ch[cn].resta,ch[cn].restx,ch[cn].resty)) exit_char(cn);
        } else {
...
void shrine_vitality(int in,int cn,int nr,int level,struct shrine_ppd *ppd) {
    ...
    for (n=cost=0; n<cnt; n++) cost+=raise_cost(v,ch[cn].value[1][v]+n,s);
...
void randomshrine(int in,int cn) {
    ...
    for (n=0; n<INVENTORYSIZE; n++) if ((in2=ch[cn].item[n]) && it[in2].ID==IID_AREA14_SHRINEKEY && it[in2].drdata[0]==it[in].drdata[1]) break;
    if (n==INVENTORYSIZE) {
    ...
    switch (it[in].drdata[0]) {
        ...
        case 7:
        case 8:
        case 9:		if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_indecisiveness(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 10:
        case 11:
        case 12:
        ...
        case 17:
        case 18:
        case 19:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_bribes(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 20:
        case 21:
        case 22:
        ...
        case 27:
        case 28:
        case 29:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_welding(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 30:
        case 31:
        case 32:
        ...
        case 37:
        case 38:
        case 39:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_edge(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        ...
        case 47:
        case 48:
        case 49:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_kindness(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 50:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_vitality(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;

        case 51:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_death(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 52:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_braveness(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 53:
        case 54:
        case 55:
        ...
        case 60:
        case 61:
        case 62:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_security(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 63:
        case 64:
        case 65:
        ...
        case 70:
        case 71:
        case 72:	if (shrine_check(cn,it[in].drdata[0],ppd)) shrine_jobless(in,cn,it[in].drdata[0],it[in].drdata[1],ppd);
            return;
        case 73:
        case 74:
        case 75:
...
void gastrap(int in,int cn) {
    ...
    if (cn) {
        if (!it[in].drdata[1]) { call_item(it[in].driver,in,0,ticker+1); } else return;
